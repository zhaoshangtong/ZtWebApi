...
namespace Utility.Redis
{
    public class StackExchangeRedisHelper
    {
        ...
        public StackExchangeRedisHelper(int dbNum = 0)
                : this(dbNum, "")
        {
        }

        public StackExchangeRedisHelper(int dbNum, string readWriteHosts)
        {
            DbNum = dbNum;
            _conn =
    ...
    public static class RedisConnectionHelp
    {
        ...
        private static readonly string RedisConnectionString = ConfigurationManager.AppSettings["RedisExchangeHosts"].ToString();
        ...
        private static ConnectionMultiplexer GetManager(string connectionString = null)
        {
            ...
            loginfo.Info("连接前："+DateTime.Now);
            var connect = ConnectionMultiplexer.Connect(connectionString);
            loginfo.Info("连接后：" + DateTime.Now);
            //注册如下事件
        ...
        {
            Utility.Log.LogHelper.Info("Configuration changed: " + e.EndPoint);
        }
        ...
        {
            Utility.Log.LogHelper.Error("ErrorMessage: " + e.Message);
        }
        ...
        {
            Utility.Log.LogHelper.Error("ConnectionRestored: " + e.EndPoint);
        }
        ...
        {
            Utility.Log.LogHelper.Info("重新连接：Endpoint failed: " + e.EndPoint + ", " + e.FailureType + (e.Exception == null ? "" : (", " + e.Exception.Message)));
        }
        ...
        {
            Utility.Log.LogHelper.Error("InternalError:Message" + e.Exception.Message);
        }
