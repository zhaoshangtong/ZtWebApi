...
public class Util
{
    ...
    #region 判断dynamic中是否包含某一项
    public static bool IsDynamicExist(dynamic data, string propertyname)
    {
    ...
    public async static Task<string> MethodPOSTAsync(string URL, string strPostdata, string strEncoding = "UTF-8", string contentType = "application/x-www-form-urlencoded")
    {
        ...
        //Tlkjbase.Common.LogHelper.Info("MethodPOSTAsync：" + strPostdata);
        ...
        //{
        //    Tlkjbase.Common.LogHelper.Info("stream.Length before：" + stream.Length);
        //    await stream.WriteAsync(buffer, 0, buffer.Length);
        //    Tlkjbase.Common.LogHelper.Info("stream.Length after：" + stream.Length);
        //}
